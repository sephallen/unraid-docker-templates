<?php
/*
 *  This file was edited by SmartPhoneLover, for the Jirafeau docker template for unRAID.
 *  The original 'config.original.env' file is available on 'https://gitlab.com/mojo42/Jirafeau/-/blob/master/lib/config.original.php'.
 *
